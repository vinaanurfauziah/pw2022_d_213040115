        ...
        <div class="container">
            <div class="card mt-5">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-5">
                    <input type="text" class="form-control" name="deskripsi" id="deskripsi" required value="<?= $stk["deskripsi"]; ?>">
                    <!-- <textarea class="form-control" name="deskripsi" id="deskripsi" rows="4" value="<?= $stk["deskripsi"]; ?>"></textarea> -->
                    </div>
                </div>
                <div class="mb-3 row">
